...
/**
 * NFT（ERC721）合约地址。
 * 与 `npm run local`（scripts/start-local.sh）在**空 Anvil**上按顺序 forge create 的第 2 个合约一致：
 * 部署账户 0xf39F… 的 nonce=1 → CREATE 地址（可用 `cast compute-address 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266 --nonce 1` 核对）。
 */
const ERC721_ADDRESS = '0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512' as `0x${string}`

/**
 * NFT 市场合约地址：721 授权里的「被授权方」也是它。
 * 同上，为空链上第 3 次 create（nonce=2）。
 */
